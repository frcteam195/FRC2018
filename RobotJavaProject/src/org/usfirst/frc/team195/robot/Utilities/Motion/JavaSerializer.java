...
public class JavaSerializer implements IPathSerializer {
  ...
  public String serialize(Path path) {
    ...
    contents += "import com.team254.lib.trajectory.Motion;\n";
    ...
    contents += "    this.go_left_pair_ = new Motion.Pair(kLeftWheel, kRightWheel);\n";
    contents += "  }\n\n";
  ...
  private String serializeTrajectory(String name, Trajectory traj) {
    String contents = 
            "  private final Motion " + name + " = new Motion( new Motion.Segment[] {\n";
    for (int i = 0; i < traj.getNumSegments(); ++i) {
      Trajectory.Segment seg = traj.getSegment(i);
      contents += "    new Motion.Segment("
