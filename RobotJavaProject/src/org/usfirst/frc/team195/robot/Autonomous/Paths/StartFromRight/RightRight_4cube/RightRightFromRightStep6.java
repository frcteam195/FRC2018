...
public class RightRightFromRightStep6 implements PathContainer {
	...
	public RigidTransform2d getStartPose() {
		return new RigidTransform2d(new Translation2d(283, 75), Rotation2d.fromDegrees(0));
	}
