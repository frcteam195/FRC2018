...
public class LeftLeftFromRightStep2 implements PathContainer {
	...
	public Path buildPath() {
		...
		sWaypoints.add(new Waypoint(253,257,15,120));
		sWaypoints.add(new Waypoint(217,239,0,60));
	...
	// WAYPOINT_DATA: [{"position":{"x":290,"y":257},"speed":0,"radius":0,"marker":"","comment":""},{"position":{"x":253,"y":257},"speed":120,"radius":15,"marker":"","comment":""},{"position":{"x":217,"y":239},"speed":60,"radius":0,"marker":"","comment":""}]
	// IS_REVERSED: false
