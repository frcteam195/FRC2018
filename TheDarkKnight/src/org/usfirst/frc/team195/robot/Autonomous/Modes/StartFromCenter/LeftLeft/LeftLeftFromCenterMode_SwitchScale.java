package org.usfirst.frc.team195.robot.Autonomous.Modes.StartFromCenter.LeftLeft;
...
import org.usfirst.frc.team195.robot.Autonomous.Paths.StartFromCenter.LeftLeftFromCenter_SwitchScale.LeftLeftFromCenter_AddPath1;
...
public class LeftLeftFromCenterMode_SwitchScale extends AutoModeBase {
...
//													   AutomatedActions.PreparePickupCube())))));
		...
		runAction(new ParallelAction(Arrays.asList(new DrivePathAction(new LeftLeftFromCenter_AddPath1()),
		...
		runAction(AutomatedActions.PreparePlaceCubeOnScaleHigh());
		runAction(AutomatedActions.OutakeCubeFast());
		runAction(AutomatedActions.StopIntake());
