...
//		sWaypoints.add(new Waypoint(160,276,30,135,"PreparePlaceCube"));
//		sWaypoints.add(new Waypoint(233,264,30,135));
...
public class Left3CubeScaleStep1 implements PathContainer {
	...
	public Path buildPath() {
		...
		sWaypoints.add(PathAdapter.getAdaptedLeftScaleWaypoint(new Waypoint(280,245,0,90)));
