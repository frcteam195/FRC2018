...
public class TestPath implements PathContainer {
	...
	public Path buildPath() {
		...
		sWaypoints.add(new Waypoint(57,290,15,60));
		sWaypoints.add(new Waypoint(100,287,15,60));
		sWaypoints.add(new Waypoint(131,260,15,60));
		sWaypoints.add(new Waypoint(145,320,0,60));
