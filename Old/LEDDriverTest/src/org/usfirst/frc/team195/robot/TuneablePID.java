...
//				setpoint = udpReceiver.getTuneablePIDData().getSetpoint();
			...
			String sendStr = "Name:" + name + ";DesiredValue:" + setpoint + ";ActualValue:" + actualValue + ";IntegralAccum:" + 10 + ";";
		...
		public void run() {
			...
			while (runThread) {
				...
				try {
					...
					System.out.println("IP: " + getIPAddress().toString());
					System.out.println("P: " + getTuneablePIDData().getkP());
