...
@Deprecated
public class DriveBaseSubsystemOld extends Thread implements CustomSubsystem, Reportable {
	public static final int MIN_DRIVE_LOOP_TIME_STANDARD = 10;
	public static final int MIN_DRIVE_LOOP_TIME_MP = 3;
	private static DriveBaseSubsystemOld instance = null;
	...
	private DriveBaseSubsystemOld() throws Exception {
		super();
	...
	public static DriveBaseSubsystemOld getInstance() {
		if(instance == null) {
			try {
				instance = new DriveBaseSubsystemOld();
			} catch (Exception ex) {
	...
	public static DriveBaseSubsystemOld getInstance(List<CustomSubsystem> subsystemList) {
