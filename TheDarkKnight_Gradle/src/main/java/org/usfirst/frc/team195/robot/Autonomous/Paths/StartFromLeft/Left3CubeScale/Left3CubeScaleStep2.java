...
public class Left3CubeScaleStep2 implements PathContainer {
	...
	public Path buildPath() {
		...
		sWaypoints.add(PathAdapter.getAdaptedLeftScaleWaypoint(new Waypoint(280,245,0,0)));
		sWaypoints.add(new Waypoint(248,249,10,30));
		sWaypoints.add(PathAdapter.getAdaptedLeftSwitchWaypoint(new Waypoint(230,241,0,30)));
	...
	public RigidTransform2d getStartPose() {
		return new RigidTransform2d(new Translation2d(280, 245), Rotation2d.fromDegrees(0));
	}
