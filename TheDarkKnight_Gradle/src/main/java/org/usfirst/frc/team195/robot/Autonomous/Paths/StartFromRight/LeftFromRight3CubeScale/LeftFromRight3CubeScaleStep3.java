...
public class LeftFromRight3CubeScaleStep3 implements PathContainer {
	...
	public Path buildPath() {
		...
		sWaypoints.add(PathAdapter.getAdaptedLeftSwitchWaypoint(new Waypoint(237,251,0,0)));
	...
	public RigidTransform2d getStartPose() {
		return new RigidTransform2d(new Translation2d(237, 251), Rotation2d.fromDegrees(180));
	}
