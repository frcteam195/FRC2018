...
public class LeftFromRight3CubeScaleStep2 implements PathContainer {
	...
	public Path buildPath() {
		...
		sWaypoints.add(PathAdapter.getAdaptedLeftScaleWaypoint(new Waypoint(283,256,0,0)));
		sWaypoints.add(new Waypoint(255,258,15,27));
		sWaypoints.add(PathAdapter.getAdaptedLeftSwitchWaypoint(new Waypoint(237,251,0,27)));
	...
	public RigidTransform2d getStartPose() {
		return new RigidTransform2d(new Translation2d(283, 256), Rotation2d.fromDegrees(0));
	}
